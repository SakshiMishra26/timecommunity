"""
Django settings for timecommunity project.
...
SECRET_KEY = 'django-insecure-=&p6x7t4lp)swmlh4aga=l_xu@4cch1+@s#%a@3w5(r9h*d3kz'
...
ROOT_URLCONF = 'timecommunity.urls'
...
WSGI_APPLICATION = 'timecommunity.wsgi.application'
...
# Ensure this points to the directory where your custom static files like 'styles.css' are
STATICFILES_DIRS = [
    BASE_DIR / "static",  # This points to the 'static' folder
]

# If you plan to collect static files for production (optional)
